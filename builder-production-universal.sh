...
# nejspis tam.
#
# Z OpenWrt strany jeste stoji za zminku f4efe1d5a6a + 26f8f9bb1b0 (wifi-scripts a
# base-files dostaly volbu vypnout obsluhu tlacitek vcetne WPS - default se nemeni,
# ale WPS onboarding meshe na tom tlacitku stoji) a ba3243bba03 (auth_type pri
# nenastavenem encryption).
#
# STAV OVERENI: postaveno 16. 9. 08:16 (build-production-2026-09-16-bump2.log). MTK e55f4f30 se starym kernelem .103 postaven na x8 16. 9. v 06:58
# bez jedine chyby patche. Kombinace s kernelem .108 se stavi timto pinem POPRVE a
# NA ZELEZE NENI OVERENA - do uzivatelskych vetvi az po testu.
